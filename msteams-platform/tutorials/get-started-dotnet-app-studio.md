...
Você pode criar e executar o smaple depois que ele for clonado. 
...
Para testar sua extensão de mensagens, selecione **...** abaixo da caixa de entrada no seu exibição de conversa. Um menu com o **aplicativo "Hello World"** é exibido. Quando você o seleciona, um conjunto de textos aleatórios é exibido. Você pode selecionar um dos textos aleatórios e que é inserido em sua conversa.
