...
author: laujan
description: Crie mensagens acionáveis, envie mensagens por meio do Webhook de entrada, Office 365 Connector, cURL ou PowerShell. Enviar Cartões Adaptáveis. Transação baseada em tempo.
ms.topic: how-to
