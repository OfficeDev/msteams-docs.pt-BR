...
description: Saiba como otimizar o bot com limitação de taxa. Detectar exceções transitórias, por limite de thread de bot. Você também pode executar uma retirada exponencial.
