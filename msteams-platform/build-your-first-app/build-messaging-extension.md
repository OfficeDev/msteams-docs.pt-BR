...
* **Bot** para a extensão de mensagens que é registrada automaticamente com o serviço Microsoft Azure Bot.
...
Se você instalou seu aplicativo, mas ele não está funcionando, certifique-se de que o bot da extensão de mensagens esteja conectado ao canal de Teams do Serviço de Bot [do Azure. ](/azure/bot-service/channel-connect-teams?view=azure-bot-service-4.0&preserve-view=true)
