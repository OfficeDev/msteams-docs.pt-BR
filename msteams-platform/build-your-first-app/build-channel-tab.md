...
> [!TIP]
> Se você ainda não criou um projeto de aplicativo do Teams antes, talvez seja útil seguir estas [instruções](../build-your-first-app/build-and-run.md) que explicam os projetos com mais detalhes.
...
Copie e atualize o trecho a seguir com informações relevantes para sua organização ou, por um tempo, use o código como estão.
...
Depois de concluído, há um **compilado com êxito!** no terminal. Seu aplicativo está sendo executado `https://localhost:3000` em.
