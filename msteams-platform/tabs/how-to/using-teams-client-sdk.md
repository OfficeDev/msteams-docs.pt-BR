...
Por exemplo, o SDK pode fazer com que sua [guia](../../build-your-first-app/build-personal-tab.md#3-update-your-tab-theme) reaja às alterações de tema que seus usuários fazem no cliente Teams cliente.
