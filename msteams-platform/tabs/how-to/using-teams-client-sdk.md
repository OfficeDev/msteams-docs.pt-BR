...
description: Visão geral do SDK do cliente JavaScript do Microsoft Teams, que pode ajudá-lo a criar experiências de aplicativo do Teams hospedadas <iframe> no Teams, no Office e no Outlook.
