...
|`parameter.inputType`|Cadeia de caracteres|128 caracteres||Define o tipo de controle exibido em um módulo de tarefa para `fetchTask: true` . Um dos `text` , , , , , `textarea` `number` `date` `time` `toggle` , `choiceset`|
