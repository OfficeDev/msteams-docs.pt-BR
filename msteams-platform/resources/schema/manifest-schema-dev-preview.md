...
> [!NOTE]
> Se você não estiver usando recursos de visualização do desenvolvedor, use o manifesto [do aplicativo para recursos GA.](~/resources/schema/manifest-schema.md)
