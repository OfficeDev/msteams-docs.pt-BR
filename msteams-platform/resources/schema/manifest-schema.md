...
|<span data-ttu-id="cdb7d-140">Nome</span><span class="sxs-lookup"><span data-stu-id="cdb7d-140">Name</span></span>| <span data-ttu-id="cdb7d-141">Tamanho máximo</span><span class="sxs-lookup"><span data-stu-id="cdb7d-141">Maximum size</span></span> | <span data-ttu-id="cdb7d-142">Obrigatório</span><span class="sxs-lookup"><span data-stu-id="cdb7d-142">Required</span></span> | <span data-ttu-id="cdb7d-143">Descrição</span><span class="sxs-lookup"><span data-stu-id="cdb7d-143">Description</span></span>|
|---|---|---|---|
...
<span data-ttu-id="cdb7d-175">Descreve seu aplicativo para usuários.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-175">Describes your app to users.</span></span> <span data-ttu-id="cdb7d-176">Para aplicativos enviados ao AppSource, esses valores devem corresponder às informações em sua entrada appSource.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-176">For apps submitted to AppSource, these values must match the information in your AppSource entry.</span></span>
...
|<span data-ttu-id="cdb7d-199">Nome</span><span class="sxs-lookup"><span data-stu-id="cdb7d-199">Name</span></span>| <span data-ttu-id="cdb7d-200">Tamanho máximo</span><span class="sxs-lookup"><span data-stu-id="cdb7d-200">Maximum size</span></span> | <span data-ttu-id="cdb7d-201">Obrigatório</span><span class="sxs-lookup"><span data-stu-id="cdb7d-201">Required</span></span> | <span data-ttu-id="cdb7d-202">Descrição</span><span class="sxs-lookup"><span data-stu-id="cdb7d-202">Description</span></span>|
|---|---|---|---|
...
<span data-ttu-id="cdb7d-233">O valor deve ser um código de cor HTML válido começando com '#', por exemplo `#4464ee` .</span><span class="sxs-lookup"><span data-stu-id="cdb7d-233">The value must be a valid HTML color code starting with '#', for example `#4464ee`.</span></span>
...
|<span data-ttu-id="cdb7d-348">Nome</span><span class="sxs-lookup"><span data-stu-id="cdb7d-348">Name</span></span>| <span data-ttu-id="cdb7d-349">Tipo</span><span class="sxs-lookup"><span data-stu-id="cdb7d-349">Type</span></span>| <span data-ttu-id="cdb7d-350">Tamanho máximo</span><span class="sxs-lookup"><span data-stu-id="cdb7d-350">Maximum size</span></span> | <span data-ttu-id="cdb7d-351">Obrigatório</span><span class="sxs-lookup"><span data-stu-id="cdb7d-351">Required</span></span> | <span data-ttu-id="cdb7d-352">Descrição</span><span class="sxs-lookup"><span data-stu-id="cdb7d-352">Description</span></span>|
|---|---|---|---|---|
...
|---|---|---|---|---|
|`botId`|<span data-ttu-id="cdb7d-414">string</span><span class="sxs-lookup"><span data-stu-id="cdb7d-414">string</span></span>|<span data-ttu-id="cdb7d-415">64</span><span class="sxs-lookup"><span data-stu-id="cdb7d-415">64</span></span>|<span data-ttu-id="cdb7d-416">✔</span><span class="sxs-lookup"><span data-stu-id="cdb7d-416">✔</span></span>|<span data-ttu-id="cdb7d-417">A ID de aplicativo exclusiva da Microsoft para o bot que é o suporte à extensão de mensagens, conforme registrado na Estrutura de Bot.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-417">The unique Microsoft app ID for the bot that backs the messaging extension, as registered with the Bot Framework.</span></span> <span data-ttu-id="cdb7d-418">Isso pode ser o mesmo que a ID geral do aplicativo.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-418">This may well be the same as the overall App ID.</span></span>|
...
|`parameters`|<span data-ttu-id="cdb7d-482">matriz de objeto</span><span class="sxs-lookup"><span data-stu-id="cdb7d-482">array of object</span></span>|<span data-ttu-id="cdb7d-483">5 itens</span><span class="sxs-lookup"><span data-stu-id="cdb7d-483">5 items</span></span>|<span data-ttu-id="cdb7d-484">✔</span><span class="sxs-lookup"><span data-stu-id="cdb7d-484">✔</span></span>|<span data-ttu-id="cdb7d-485">A lista de parâmetros que o comando assume.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-485">The list of parameters the command takes.</span></span> <span data-ttu-id="cdb7d-486">Mínimo: 1; máximo: 5.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-486">Minimum: 1; maximum: 5.</span></span>|
...
<span data-ttu-id="cdb7d-519">**Opcional** — matriz de cadeias de caracteres</span><span class="sxs-lookup"><span data-stu-id="cdb7d-519">**Optional** — array of strings</span></span>
...
<span data-ttu-id="cdb7d-538">Teams aplicativos que exigem que suas próprias URLs do sharepoint funcionem bem, inclui "{teamsitedomain}" em sua lista de domínios válida.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-538">Teams apps that require their own sharepoint URLs to function well, includes "{teamsitedomain}" in their valid domain list.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="cdb7d-539">Não adicione domínios que estão fora do seu controle, diretamente ou por meio de caracteres curinga.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-539">Do not add domains that are outside your control, either directly or through wildcards.</span></span> <span data-ttu-id="cdb7d-540">Por exemplo, `yourapp.onmicrosoft.com` é válido, no entanto, `*.onmicrosoft.com` não é válido.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-540">For example, `yourapp.onmicrosoft.com` is valid, however, `*.onmicrosoft.com` is not valid.</span></span>

<span data-ttu-id="cdb7d-541">O objeto é uma matriz com todos os elementos do tipo `string` .</span><span class="sxs-lookup"><span data-stu-id="cdb7d-541">The object is an array with all elements of the type `string`.</span></span>

## <a name="webapplicationinfo"></a><span data-ttu-id="cdb7d-542">webApplicationInfo</span><span class="sxs-lookup"><span data-stu-id="cdb7d-542">webApplicationInfo</span></span>

<span data-ttu-id="cdb7d-543">**Opcional** — objeto</span><span class="sxs-lookup"><span data-stu-id="cdb7d-543">**Optional** — object</span></span>

<span data-ttu-id="cdb7d-544">Forneça sua Azure Active Directory (AAD) app ID e informações do Microsoft Graph para ajudar os usuários a entrar perfeitamente em seu aplicativo.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-544">Provide your Azure Active Directory (AAD) App ID and Microsoft Graph information to help users seamlessly sign into your app.</span></span> <span data-ttu-id="cdb7d-545">Se seu aplicativo estiver registrado no AAD, você deverá fornecer a ID do aplicativo, para que os administradores possam revisar facilmente as permissões e conceder consentimento Teams centro de administração.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-545">If your app is registered in AAD, you must provide the App ID, so that administrators can easily review permissions and grant consent in Teams admin center.</span></span>

|<span data-ttu-id="cdb7d-546">Nome</span><span class="sxs-lookup"><span data-stu-id="cdb7d-546">Name</span></span>| <span data-ttu-id="cdb7d-547">Tipo</span><span class="sxs-lookup"><span data-stu-id="cdb7d-547">Type</span></span>| <span data-ttu-id="cdb7d-548">Tamanho máximo</span><span class="sxs-lookup"><span data-stu-id="cdb7d-548">Maximum size</span></span> | <span data-ttu-id="cdb7d-549">Obrigatório</span><span class="sxs-lookup"><span data-stu-id="cdb7d-549">Required</span></span> | <span data-ttu-id="cdb7d-550">Descrição</span><span class="sxs-lookup"><span data-stu-id="cdb7d-550">Description</span></span>|
|---|---|---|---|---|
|`id`|<span data-ttu-id="cdb7d-551">string</span><span class="sxs-lookup"><span data-stu-id="cdb7d-551">string</span></span>|<span data-ttu-id="cdb7d-552">36 caracteres</span><span class="sxs-lookup"><span data-stu-id="cdb7d-552">36 characters</span></span>|<span data-ttu-id="cdb7d-553">✔</span><span class="sxs-lookup"><span data-stu-id="cdb7d-553">✔</span></span>|<span data-ttu-id="cdb7d-554">ID do aplicativo AAD do aplicativo.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-554">AAD application id of the app.</span></span> <span data-ttu-id="cdb7d-555">Essa id deve ser um GUID.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-555">This id must be a GUID.</span></span>|
|`resource`|<span data-ttu-id="cdb7d-556">cadeia de caracteres</span><span class="sxs-lookup"><span data-stu-id="cdb7d-556">string</span></span>|<span data-ttu-id="cdb7d-557">2048 caracteres</span><span class="sxs-lookup"><span data-stu-id="cdb7d-557">2048 characters</span></span>|<span data-ttu-id="cdb7d-558">✔</span><span class="sxs-lookup"><span data-stu-id="cdb7d-558">✔</span></span>|<span data-ttu-id="cdb7d-559">URL de recurso do aplicativo para adquirir token de autenticação para SSO.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-559">Resource URL of app for acquiring auth token for SSO.</span></span> </br> <span data-ttu-id="cdb7d-560">**OBSERVAÇÃO:** Se você não estiver usando o SSO, certifique-se de inserir um valor de cadeia de caracteres fictício neste campo para o manifesto do aplicativo, por exemplo, para evitar https://notapplicable uma resposta de erro.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-560">**NOTE:** If you are not using SSO, ensure that you enter a dummy string value in this field to your app manifest, for example, https://notapplicable to avoid an error response.</span></span> |
|`applicationPermissions`|<span data-ttu-id="cdb7d-561">matriz de cadeia de caracteres</span><span class="sxs-lookup"><span data-stu-id="cdb7d-561">array of strings</span></span>|<span data-ttu-id="cdb7d-562">128 caracteres</span><span class="sxs-lookup"><span data-stu-id="cdb7d-562">128 characters</span></span>||<span data-ttu-id="cdb7d-563">Especifique o [consentimento específico do recurso granular](../../graph-api/rsc/resource-specific-consent.md#resource-specific-permissions).</span><span class="sxs-lookup"><span data-stu-id="cdb7d-563">Specify granular [resource specific consent](../../graph-api/rsc/resource-specific-consent.md#resource-specific-permissions).</span></span>|

## <a name="showloadingindicator"></a><span data-ttu-id="cdb7d-564">showLoadingIndicator</span><span class="sxs-lookup"><span data-stu-id="cdb7d-564">showLoadingIndicator</span></span>

<span data-ttu-id="cdb7d-565">**Opcional** — booleano</span><span class="sxs-lookup"><span data-stu-id="cdb7d-565">**Optional** — boolean</span></span>

<span data-ttu-id="cdb7d-566">Indica se é ou não para mostrar o indicador de carregamento quando um aplicativo ou guia está sendo carregado.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-566">Indicates whether or not to show the loading indicator when an app or tab is loading.</span></span> <span data-ttu-id="cdb7d-567">O padrão é **false**.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-567">Default is **false**.</span></span>
>[!NOTE]
><span data-ttu-id="cdb7d-568">Se você selecionar como true no manifesto do aplicativo, para carregar a página corretamente, modifique as páginas de conteúdo de suas guias e módulos de tarefa conforme descrito em Mostrar um documento indicador de carregamento `showLoadingIndicator` nativo. [](../../tabs/how-to/create-tab-pages/content-page.md#show-a-native-loading-indicator)</span><span class="sxs-lookup"><span data-stu-id="cdb7d-568">If you select`showLoadingIndicator` as true in your app manifest, to load the page correctly, modify the content pages of your tabs and task modules as described in [Show a native loading indicator](../../tabs/how-to/create-tab-pages/content-page.md#show-a-native-loading-indicator) document.</span></span>


## <a name="isfullscreen"></a><span data-ttu-id="cdb7d-569">isFullScreen</span><span class="sxs-lookup"><span data-stu-id="cdb7d-569">isFullScreen</span></span>

 <span data-ttu-id="cdb7d-570">**Opcional** — booleano</span><span class="sxs-lookup"><span data-stu-id="cdb7d-570">**Optional** — boolean</span></span>

<span data-ttu-id="cdb7d-571">Indica onde um aplicativo pessoal é renderizado com ou sem uma barra de header de tabulação.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-571">Indicate where a personal app is rendered with or without a tab header bar.</span></span> <span data-ttu-id="cdb7d-572">O padrão é **false**.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-572">Default is **false**.</span></span>

## <a name="activities"></a><span data-ttu-id="cdb7d-573">activities</span><span class="sxs-lookup"><span data-stu-id="cdb7d-573">activities</span></span>

<span data-ttu-id="cdb7d-574">**Opcional** — objeto</span><span class="sxs-lookup"><span data-stu-id="cdb7d-574">**Optional** — object</span></span>

<span data-ttu-id="cdb7d-575">Defina as propriedades que seu aplicativo usa para postar um feed de atividade do usuário.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-575">Define the properties your app uses to post a user activity feed.</span></span>

|<span data-ttu-id="cdb7d-576">Nome</span><span class="sxs-lookup"><span data-stu-id="cdb7d-576">Name</span></span>| <span data-ttu-id="cdb7d-577">Tipo</span><span class="sxs-lookup"><span data-stu-id="cdb7d-577">Type</span></span>| <span data-ttu-id="cdb7d-578">Tamanho máximo</span><span class="sxs-lookup"><span data-stu-id="cdb7d-578">Maximum size</span></span> | <span data-ttu-id="cdb7d-579">Obrigatório</span><span class="sxs-lookup"><span data-stu-id="cdb7d-579">Required</span></span> | <span data-ttu-id="cdb7d-580">Descrição</span><span class="sxs-lookup"><span data-stu-id="cdb7d-580">Description</span></span>|
|---|---|---|---|---|
|`activityTypes`|<span data-ttu-id="cdb7d-581">matriz de objetos</span><span class="sxs-lookup"><span data-stu-id="cdb7d-581">array of Objects</span></span>|<span data-ttu-id="cdb7d-582">128 itens</span><span class="sxs-lookup"><span data-stu-id="cdb7d-582">128 items</span></span>| | <span data-ttu-id="cdb7d-583">Forneça os tipos de atividades que seu aplicativo pode postar em um feed de atividades dos usuários.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-583">Provide the types of activities that your app can post to a users activity feed.</span></span>|

### <a name="activitiesactivitytypes"></a><span data-ttu-id="cdb7d-584">activities.activityTypes</span><span class="sxs-lookup"><span data-stu-id="cdb7d-584">activities.activityTypes</span></span>

|<span data-ttu-id="cdb7d-585">Nome</span><span class="sxs-lookup"><span data-stu-id="cdb7d-585">Name</span></span>| <span data-ttu-id="cdb7d-586">Tipo</span><span class="sxs-lookup"><span data-stu-id="cdb7d-586">Type</span></span>| <span data-ttu-id="cdb7d-587">Tamanho máximo</span><span class="sxs-lookup"><span data-stu-id="cdb7d-587">Maximum size</span></span> | <span data-ttu-id="cdb7d-588">Obrigatório</span><span class="sxs-lookup"><span data-stu-id="cdb7d-588">Required</span></span> | <span data-ttu-id="cdb7d-589">Descrição</span><span class="sxs-lookup"><span data-stu-id="cdb7d-589">Description</span></span>|
|---|---|---|---|---|
|`type`|<span data-ttu-id="cdb7d-590">string</span><span class="sxs-lookup"><span data-stu-id="cdb7d-590">string</span></span>|<span data-ttu-id="cdb7d-591">32 caracteres</span><span class="sxs-lookup"><span data-stu-id="cdb7d-591">32 characters</span></span>|<span data-ttu-id="cdb7d-592">✔</span><span class="sxs-lookup"><span data-stu-id="cdb7d-592">✔</span></span>|<span data-ttu-id="cdb7d-593">O tipo de notificação.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-593">The notification type.</span></span> <span data-ttu-id="cdb7d-594">*Consulte abaixo*.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-594">*See below*.</span></span>|
|`description`|<span data-ttu-id="cdb7d-595">cadeia de caracteres</span><span class="sxs-lookup"><span data-stu-id="cdb7d-595">string</span></span>|<span data-ttu-id="cdb7d-596">128 caracteres</span><span class="sxs-lookup"><span data-stu-id="cdb7d-596">128 characters</span></span>|<span data-ttu-id="cdb7d-597">✔</span><span class="sxs-lookup"><span data-stu-id="cdb7d-597">✔</span></span>|<span data-ttu-id="cdb7d-598">Uma breve descrição da notificação.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-598">A brief description of the notification.</span></span> <span data-ttu-id="cdb7d-599">*Consulte abaixo*.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-599">*See below*.</span></span>|
|`templateText`|<span data-ttu-id="cdb7d-600">cadeia de caracteres</span><span class="sxs-lookup"><span data-stu-id="cdb7d-600">string</span></span>|<span data-ttu-id="cdb7d-601">128 caracteres</span><span class="sxs-lookup"><span data-stu-id="cdb7d-601">128 characters</span></span>|<span data-ttu-id="cdb7d-602">✔</span><span class="sxs-lookup"><span data-stu-id="cdb7d-602">✔</span></span>|<span data-ttu-id="cdb7d-603">Ex: "{actor} criado tarefa {taskId} para você"</span><span class="sxs-lookup"><span data-stu-id="cdb7d-603">Ex: "{actor} created task {taskId} for you"</span></span>|
...
## <a name="defaultinstallscope"></a><span data-ttu-id="cdb7d-604">defaultInstallScope</span><span class="sxs-lookup"><span data-stu-id="cdb7d-604">defaultInstallScope</span></span>

<span data-ttu-id="cdb7d-605">**Opcional** - cadeia de caracteres</span><span class="sxs-lookup"><span data-stu-id="cdb7d-605">**Optional** - string</span></span>

<span data-ttu-id="cdb7d-606">Especifica o escopo de instalação definido para este aplicativo por padrão.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-606">Specifies the install scope defined for this app by default.</span></span> <span data-ttu-id="cdb7d-607">O escopo definido será a opção exibida no botão quando um usuário tentar adicionar o aplicativo.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-607">The defined scope will be the option displayed on the button when a user tries to add the app.</span></span> <span data-ttu-id="cdb7d-608">As opções são:</span><span class="sxs-lookup"><span data-stu-id="cdb7d-608">Options are:</span></span>
* `personal`
* `team`
* `groupchat`
* `meetings`

## <a name="defaultgroupcapability"></a><span data-ttu-id="cdb7d-609">defaultGroupCapability</span><span class="sxs-lookup"><span data-stu-id="cdb7d-609">defaultGroupCapability</span></span>

<span data-ttu-id="cdb7d-610">**Opcional** - objeto</span><span class="sxs-lookup"><span data-stu-id="cdb7d-610">**Optional** - object</span></span>

<span data-ttu-id="cdb7d-611">Quando um escopo de instalação de grupo é selecionado, ele define o recurso padrão quando o usuário instala o aplicativo.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-611">When a group install scope is selected, it will define the default capability when the user installs the app.</span></span> <span data-ttu-id="cdb7d-612">As opções são:</span><span class="sxs-lookup"><span data-stu-id="cdb7d-612">Options are:</span></span>
* `team`
* `groupchat`
* `meetings`
 
|<span data-ttu-id="cdb7d-613">Nome</span><span class="sxs-lookup"><span data-stu-id="cdb7d-613">Name</span></span>| <span data-ttu-id="cdb7d-614">Tipo</span><span class="sxs-lookup"><span data-stu-id="cdb7d-614">Type</span></span>| <span data-ttu-id="cdb7d-615">Tamanho máximo</span><span class="sxs-lookup"><span data-stu-id="cdb7d-615">Maximum size</span></span> | <span data-ttu-id="cdb7d-616">Obrigatório</span><span class="sxs-lookup"><span data-stu-id="cdb7d-616">Required</span></span> | <span data-ttu-id="cdb7d-617">Descrição</span><span class="sxs-lookup"><span data-stu-id="cdb7d-617">Description</span></span>|
|---|---|---|---|---|
|`team`|<span data-ttu-id="cdb7d-618">string</span><span class="sxs-lookup"><span data-stu-id="cdb7d-618">string</span></span>|||<span data-ttu-id="cdb7d-619">Quando o escopo de instalação selecionado for `team` , este campo especifica o recurso padrão disponível.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-619">When the install scope selected is `team`, this field specifies the default capability available.</span></span> <span data-ttu-id="cdb7d-620">Opções: `tab` `bot` , ou `connector` .</span><span class="sxs-lookup"><span data-stu-id="cdb7d-620">Options: `tab`, `bot`, or `connector`.</span></span>|
|`groupchat`|<span data-ttu-id="cdb7d-621">cadeia de caracteres</span><span class="sxs-lookup"><span data-stu-id="cdb7d-621">string</span></span>|||<span data-ttu-id="cdb7d-622">Quando o escopo de instalação selecionado for `groupchat` , este campo especifica o recurso padrão disponível.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-622">When the install scope selected is `groupchat`, this field specifies the default capability available.</span></span> <span data-ttu-id="cdb7d-623">Opções: `tab` `bot` , ou `connector` .</span><span class="sxs-lookup"><span data-stu-id="cdb7d-623">Options: `tab`, `bot`, or `connector`.</span></span>|
|`meetings`|<span data-ttu-id="cdb7d-624">cadeia de caracteres</span><span class="sxs-lookup"><span data-stu-id="cdb7d-624">string</span></span>|||<span data-ttu-id="cdb7d-625">Quando o escopo de instalação selecionado for `meetings` , este campo especifica o recurso padrão disponível.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-625">When the install scope selected is `meetings`, this field specifies the default capability available.</span></span> <span data-ttu-id="cdb7d-626">Opções: `tab` `bot` , ou `connector` .</span><span class="sxs-lookup"><span data-stu-id="cdb7d-626">Options: `tab`, `bot`, or `connector`.</span></span>|

## <a name="configurableproperties"></a><span data-ttu-id="cdb7d-627">configurableProperties</span><span class="sxs-lookup"><span data-stu-id="cdb7d-627">configurableProperties</span></span>

<span data-ttu-id="cdb7d-628">**Opcional** - matriz</span><span class="sxs-lookup"><span data-stu-id="cdb7d-628">**Optional** - array</span></span>

<span data-ttu-id="cdb7d-629">O `configurableProperties` bloco define as propriedades do aplicativo que Teams administrador pode personalizar.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-629">The `configurableProperties` block defines the app properties that Teams admin can customize.</span></span> <span data-ttu-id="cdb7d-630">Para obter mais informações, consulte [personalizar aplicativos em Microsoft Teams](/MicrosoftTeams/customize-apps).</span><span class="sxs-lookup"><span data-stu-id="cdb7d-630">For more information, see [customize apps in Microsoft Teams](/MicrosoftTeams/customize-apps).</span></span>

> [!NOTE]
> <span data-ttu-id="cdb7d-631">Um mínimo de uma propriedade deve ser definido.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-631">A minimum of one property must be defined.</span></span> <span data-ttu-id="cdb7d-632">Você pode definir um máximo de nove propriedades neste bloco.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-632">You can define a maximum of nine properties in this block.</span></span>
> <span data-ttu-id="cdb7d-633">Como prática prática prática, você deve fornecer diretrizes de personalização para usuários de aplicativos e clientes a seguir ao personalizar seu aplicativo.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-633">As a best practice, you must provide customization guidelines for app users and customers to follow when customizing your app.</span></span>

<span data-ttu-id="cdb7d-634">Você pode definir qualquer uma das seguintes propriedades:</span><span class="sxs-lookup"><span data-stu-id="cdb7d-634">You can define any of the following properties:</span></span>
* <span data-ttu-id="cdb7d-635">`name`: Permite que o administrador altere o nome de exibição do aplicativo.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-635">`name`: Allows admin to change the app's display name.</span></span>
* <span data-ttu-id="cdb7d-636">`shortDescription`: Permite que o administrador altere a descrição curta do aplicativo.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-636">`shortDescription`: Allows admin to change the app's short description.</span></span>
* <span data-ttu-id="cdb7d-637">`longDescription`: Permite que o administrador altere a descrição detalhada do aplicativo.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-637">`longDescription`: Allows admin to change the app's detailed description.</span></span>
* <span data-ttu-id="cdb7d-638">`smallImageUrl`: É a `outline` propriedade no bloco do `icons` manifesto.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-638">`smallImageUrl`: It is the `outline` property in the `icons` block of the manifest.</span></span>
* <span data-ttu-id="cdb7d-639">`largeImageUrl`: É a `color` propriedade no bloco do `icons` manifesto.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-639">`largeImageUrl`: It is the `color` property in the `icons` block of the manifest.</span></span>
* <span data-ttu-id="cdb7d-640">`accentColor`: É a cor a ser usada em conjunto com e como plano de fundo para seus ícones de contorno.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-640">`accentColor`: It is the color to use in conjunction with and as a background for your outline icons.</span></span>
* <span data-ttu-id="cdb7d-641">`websiteUrl`: É a URL https:// para o site do desenvolvedor.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-641">`websiteUrl`: It is the https:// URL to the developer's website.</span></span>
* <span data-ttu-id="cdb7d-642">`privacyUrl`: É a URL https:// da política de privacidade do desenvolvedor.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-642">`privacyUrl`: It is the https:// URL to the developer's privacy policy.</span></span>
* <span data-ttu-id="cdb7d-643">`termsOfUseUrl`: É a URL https:// para os termos de uso do desenvolvedor.</span><span class="sxs-lookup"><span data-stu-id="cdb7d-643">`termsOfUseUrl`: It is the https:// URL to the developer's terms of use.</span></span>
