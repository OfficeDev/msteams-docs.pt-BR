...
A flexibilidade de `messageBack` significa que seu código não pode deixar uma mensagem de usuário visível no histórico simplesmente não usando `displayText`.
