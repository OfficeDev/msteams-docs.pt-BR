...
Há três tipos de cartões que dão suporte à redução no Microsoft Teams:
...
* **Cartões simples**: há suporte para HTML limitado, mas não há suporte para redução em cartões simples.

## <a name="markdown-formatting-for-adaptive-cards"></a>Redução da formatação de cartões adaptáveis
...
## <a name="html-formatting-for-connector-cards"></a>Formatação HTML para cartões de conector
...
## <a name="markdown-formatting-for-connector-cards"></a>Redução da formatação de cartões de conector

Os cartões de conector dão suporte à redução limitada e à formatação HTML. HTML é descrito na última seção.
...
## <a name="html-formatting-for-simple-cards"></a>Formatação HTML para cartões simples

Essas marcas HTML têm suporte para cartões simples como o herói e o cartão de miniatura. Não há suporte para redução.
