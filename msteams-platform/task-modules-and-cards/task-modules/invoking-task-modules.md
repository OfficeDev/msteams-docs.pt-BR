...
Dependendo de como você está invocando seu `card`, você deve usar um cartão adaptável ou um anexo de cartão de bot do Cartão Adaptável, que é um Cartão Adaptável encapsulado em um objeto de anexo.
...
O código a seguir fornece um exemplo de um anexo de cartão de bot do Cartão Adaptável quando você está invocando de um bot:
