...
|-|-|-|-|-|-|
|`Teamwork.Migrate.All`|Gerenciar a migração do Microsoft Teams|Criar e gerenciar recursos para migração ao Microsoft Teams.|**Somente aplicativo**|Sim|`POST /teams`|
