---
title: Testar o consentimento específico do recurso para um chat em Teams
description: Como testar o consentimento específico do recurso para um chat em Teams usando o Postman
...
ms.locfileid: "52994396"
---
# <a name="test-chat-rsc-postman-collection-for-json"></a><span data-ttu-id="544c8-104">Test chat RSC Postman collection for JSON</span><span class="sxs-lookup"><span data-stu-id="544c8-104">Test chat RSC Postman collection for JSON</span></span>
