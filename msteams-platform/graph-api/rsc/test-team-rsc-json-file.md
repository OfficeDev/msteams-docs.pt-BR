...
description: Neste módulo, saiba como testar o consentimento específico do recurso para uma equipe no Teams postman com um arquivo JSON de exemplo.
